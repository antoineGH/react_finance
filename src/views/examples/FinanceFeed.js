...
import { news } from '../currency/utils/newsFeedJson'
						...
						<Col lg='12'>
							<Card className='shadow'>
								...
								{/* <Col
										...
										lg={6}
										xl={8}
										className='mx-lg-1 mb-1 mt-1'>
										<Form
											className='justify-content-left text-left ml-1'
									...
									<Row>
										<Col
											...
											<p
												...
												className='text-muted'>
												Search tickers e.g. BTC, TSLA or assets e.g.
												Bitcoin, Tesla (Comma separated).
											</p>
										</Col>
									</Row> */}
								{/* INFO: Form Filter */}
