				...
				<ListGroup horizontal>
					<Row className='justify-content-center mt-3 mb-4'>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }} className='ml-xs-0 ml-md-3'>
							<ListGroup.Item className={this.props.active === '5days' && 'active'} action onClick={this.getFiveDays}>
								5 Days
							</ListGroup.Item>
						</Col>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }}>
							<ListGroup.Item className={this.props.active === '7days' && 'active'} action onClick={this.getWeek}>
								7 Days
							</ListGroup.Item>
						</Col>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }}>
							<ListGroup.Item className={this.props.active === 'month' && 'active'} action onClick={this.getMonth}>
								1 Month
							</ListGroup.Item>
						</Col>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }}>
							<ListGroup.Item className={this.props.active === '3months' && 'active'} action onClick={this.getThreeMonths}>
								3 Months
							</ListGroup.Item>
						</Col>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }}>
							<ListGroup.Item className={this.props.active === '6months' && 'active'} action onClick={this.getSixMonths}>
								6 Months
							</ListGroup.Item>
						</Col>
						<Col xs={11} md={'auto'} style={{ paddingLeft: '0px', paddingRight: '0px' }}>
							<ListGroup.Item className={this.props.active === 'year' && 'active'} action onClick={this.getYear}>
								1 Year
							</ListGroup.Item>
						</Col>
					</Row>
