...
import { backgroundColorContext, borderColorContext, pointBackgroundColorContext, pointHoverBackgroundColorContext } from './examples/StyleContext'
				...
				<backgroundColorContext.Consumer>
					{(backgroundColor) => (
						<borderColorContext.Consumer>
							{(borderColor) => (
								<pointBackgroundColorContext.Consumer>
									{(pointBackgroundColor) => (
										<pointHoverBackgroundColorContext.Consumer>
